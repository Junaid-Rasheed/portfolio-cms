...
const data = {
  id: 1,
  description:
    "My school is in Portland, Oregon USA. For the sixth consecutive year, Catlin Gabel School has been named the #1 Best Private K-12 School in the state, and ranked in the top 1% of all private schools nationally. All our classes are at the AP level, so we are told.",
  author: "Education",
